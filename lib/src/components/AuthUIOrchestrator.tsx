...
import { useOxFutbolIdContext } from "@/providers";
import { createThirdwebWalletButton } from "@/utils";

import { MatchainConnect } from "./MatchainConnect";
...
export function AuthUIOrchestrator({ claimComponent, connectComponent }: AuthUIOrchestratorProps) {
  const { activeWallet, isClaimPending, isWaitingForSignature, claim } = useOxFutbolIdContext();
